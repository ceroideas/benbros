 ...
 *   https://datatables.net/download/#dt/dt-1.11.5/fc-4.0.2/r-2.2.9/sc-2.0.5/sb-1.3.2
 *
 * Included libraries:
 *   DataTables 1.11.5, FixedColumns 4.0.2, Responsive 2.2.9, Scroller 2.0.5, SearchBuilder 1.3.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.models.oSearch = {
		...
		DataTable.ext = _ext = {
			 ...
			 *  @type string
			 */
			build:"dt/dt-1.11.5/fc-4.0.2/r-2.2.9/sc-2.0.5/sb-1.3.2",
